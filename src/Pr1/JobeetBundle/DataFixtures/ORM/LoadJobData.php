<?php
namespace Pr1\JobeetBundle\DataFixtures\ORM;
...
class LoadJobData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $em)
    {
         ...
         $job_sensio_labs->setExpiresAt(new DateTime('+90 days'));
         ...
         $job_extreme_sensio->setExpiresAt(new DateTime('+90 days'));
         ...
         $job_expired->setExpiresAt(new DateTime('2006-01-01'));
      ...
      for($i = 100; $i <= 130; $i++)
    {
         ...
         $job->setExpiresAt(new DateTime('+90 days')); 
